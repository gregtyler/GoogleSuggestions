...
- The names of all AAAS members in the [Evolutionary and Population Biology and Ecology section](https://www.amacad.org/multimedia/pdfs/classlist.pdf) (`r sum(t.aaas$sex=="F")` women, `r sum(t.aaas$sex=="M")` men, [download the list of names](aaas.csv).);

...
```{r}
chisq.test(table(wh=t.actors$wh, sex=as.factor(t.actors$sex)))
...
```{r}
chisq.test(table(wh=t.tennis$wh, sex=as.factor(t.tennis$sex)))
...
```{r}
chisq.test(table(wh=t.science$wh, sex=as.factor(t.science$sex)))
...
```{r}
chisq.test(table(wh=t.science[t.science$HHMI==1, "wh"], sex=as.factor(t.science[t.science$HHMI==1, "sex"])))
...
tab
```
but the numbers are too small in the HHMI subset of the science data to run conclusive analyses. 

...
There is a strong difference between male and female tennis players, but maybe not the one you'd expect: "husband" or "wife" appear in Google's suggestions for `r xx$nFwh[xx$cat=="tennis"]` women out of the `r sum(t.tennis$sex[t.tennis$sex==1])` of the dataset, while they appear for `r xx$nMwh[xx$cat=="tennis"]` men (out of `r sum(t.tennis$sex[t.tennis$sex==0])`). One reason may be that, for an equivalent ranking, the popularity of female tennis players is lower than the popularity of male tennis players. 
```{r}
